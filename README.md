...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/zenpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15432&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zenpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `zenpy` can be installed with:

```
conda install zenpy
```

It is possible to list all of the versions of `zenpy` available on your platform with:
